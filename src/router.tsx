...
export const getRouter = () => {
  ...
  const router = createRouter({
    ...
    // ⚠️ جرّبنا View Transitions (تلاشي بين الصفحات) بعدة محاولات — كل
    // محاولة كشفت مشكلة بصرية جديدة (تراكب ضوئي مع عناصر الزجاج، دائرة
    // التبويب تتجمّد وتقفز، وأخيراً تراكب محتوى صفحتين فوق بعض أثناء
    // التلاشي نفسه على أجهزة/شبكات معينة). عباس فضّل الانتقال المباشر
    // أصلاً بمكان ثاني (دائرة التبويب) — رجعنا لنفس المبدأ هنا: انتقال
    // فوري بدون أي تأثير، أبسط وأثبت من محاولة "تحسين" شيء يكسر أكثر
    // مما يصلح.
  });
