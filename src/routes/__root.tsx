...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "موقع سويته لثانوية الذرى الذكية بكربلاء — تكدر تشوف جدولك وامتحاناتك وواجباتك وتساوي كل شي بمكان وحد. سويته بنفسي (عباس فاضل)، مو مشروع رسمي من إدارة المدرسة." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "ثانوية الذرى الذكية للمتميزين | كربلاء المقدسة" },
      { name: "twitter:description", content: "موقع سويته لثانوية الذرى الذكية بكربلاء — تكدر تشوف جدولك وامتحاناتك وواجباتك وتساوي كل شي بمكان وحد. سويته بنفسي (عباس فاضل)، مو مشروع رسمي من إدارة المدرسة." },
